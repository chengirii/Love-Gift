...
$('body').append """
  ...
  <div style = 'position: fixed;left: 30px;bottom: 10px;'>
    ...
    <a style='color: #fff' href='http://love.changchen.cc'>重新播放</a>
    <a style='color: #fff' target="_blank" href='https://github.com/kevinchangg/Love-Gift'>项目地址</a>
    <a style='color: #fff' target="_blank" href='http://changchen.cc'>我的博客</a>
  </div>
"""


#  <a href='https://changchen.cc'>Kevin</a>
